...
AI stalls or governments shut the frontier down. This sits outside the Plan A probabilities above.
...
We condition on rapid AI progress and leave aside our roughly 35% chance that progress plateaus first. The boring decade remains visible above, but it is outside the Plan A probability denominator.
...
AI 2040's 42% "great future" is global. It does not guarantee that ANZ remains democratic. We put homegrown autocracy after that outcome and give it a 30% conditional probability. This is our estimate, not AI 2040's. Under Plan A, the path is 42% x 30% = 12.6%. The other 29.4% reaches the later ANZ choices with political power still spread.
