...
AI 2040 does not assign these roles to ANZ. We think ANZ should outspend its allies to build capacity in steering and model personas, cultural-alignment evaluations, industrial cyber and hacking evaluations, and locked-down border biosecurity. These areas look neglected and remain useful across several futures. Treaty verification could draw on some of the same researchers.
