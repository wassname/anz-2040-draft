...
AI 2040's "great future" is global. ANZ could still become autocratic, so we add that as a conditional risk using the mechanisms in Forethought's [*AI-Enabled Coups*](https://www.forethought.org/research/ai-enabled-coups-how-a-small-group-could-use-ai-to-seize-power).
