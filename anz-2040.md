...
We assume the US chooses Plan A and China accepts: a verified slowdown with total research transparency.
...
The technical preparation is set out in AI 2040's [alignment roadmap](https://ai-2040.com/supplements/alignment-roadmap).
...
ANZ could fund stricter border biosecurity, including capacity for week-long airport quarantine during high-risk periods and [privacy-preserving contact tracing](https://theconversation.com/coronavirus-digital-contact-tracing-doesnt-have-to-sacrifice-privacy-136786).

### 2. Train specialists (2026-29)

ANZ cannot outspend frontier powers on models. It could outspend larger allies in a few overlooked areas that the treaty will need. AI 2040's alignment roadmap includes work on model behaviour:
...
AI 2040 does not assign these roles to ANZ. We think ANZ should outspend its allies to build capacity in steering and model personas, industrial cyber and hacking evaluations, and locked-down border biosecurity. Treaty verification could draw on some of the same researchers.
...
### VIII. ~~Homegrown autocracy~~ free beer and rugby for life
...
AI 2040's expanded probability cells do not score democracy inside foreign middle powers. We add that question to its 42% branch using our 30% estimate, for the reasons laid out in Forethought's [*AI-Enabled Coups*](https://www.forethought.org/research/ai-enabled-coups-how-a-small-group-could-use-ai-to-seize-power).
<!-- Claude: AI 2040 Plan A great future 0.42 x our conditional ANZ autocracy estimate 0.30 = 0.126 absolute; 0.42 x 0.70 = 0.294 remains democratic. -->
...
Thanks also to Michael J. Kerrison of [AI Safety Australia & New Zealand](https://www.aisafetyanz.com.au/), who convened a June 2026 scoping discussion, and to Rebecca Hawkins, Tom Barber, and others in the AI 2027 group who joined it.
