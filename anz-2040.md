...
AI 2040 does not assign these roles to ANZ. We think ANZ should outspend its allies to build capacity in steering and model personas, industrial cyber and hacking evaluations, locked-down border biosecurity, and locally grounded cultural-alignment evaluations. [LocalValueBench](https://arxiv.org/abs/2408.01460) already tests Australian values. We propose extending work like this across Australia, Aotearoa New Zealand, and the Pacific. Treaty verification could draw on some of the same researchers.
